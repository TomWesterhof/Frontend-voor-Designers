...
function groen_functie() {
  rood1.classList.add('weghalen_animatie');
  blauw1.classList.add('weghalen_animatie');
  geel1.classList.add('weghalen_animatie');
  groen1.classList.remove('weghalen_animatie');
  rood2.classList.add('weghalen_animatie');
  blauw2.classList.add('weghalen_animatie');
  geel2.classList.add('weghalen_animatie');
  groen2.classList.remove('weghalen_animatie');
  setTimeout(function (){
...
function geel_functie() {
  rood1.classList.add('weghalen_animatie');
  blauw1.classList.add('weghalen_animatie');
  geel1.classList.remove('weghalen_animatie');
  groen1.classList.add('weghalen_animatie');
  rood2.classList.add('weghalen_animatie');
  blauw2.classList.add('weghalen_animatie');
  geel2.classList.remove('weghalen_animatie');
  groen2.classList.add('weghalen_animatie');
  setTimeout(function (){
    rood1.classList.add('weghalen');
    blauw1.classList.add('weghalen');
...
function rood_functie() {
  rood1.classList.remove('weghalen_animatie');
  blauw1.classList.add('weghalen_animatie');
  geel1.classList.add('weghalen_animatie');
  groen1.classList.add('weghalen_animatie');
  rood2.classList.remove('weghalen_animatie');
  blauw2.classList.add('weghalen_animatie');
  geel2.classList.add('weghalen_animatie');
  groen2.classList.add('weghalen_animatie');
  setTimeout(function (){
...
function blauw_functie() {
  rood1.classList.add('weghalen_animatie');
  blauw1.classList.remove('weghalen_animatie');
  geel1.classList.add('weghalen_animatie');
  groen1.classList.add('weghalen_animatie');
  rood2.classList.add('weghalen_animatie');
  blauw2.classList.remove('weghalen_animatie');
  geel2.classList.add('weghalen_animatie');
  groen2.classList.add('weghalen_animatie');
  setTimeout(function (){
    rood1.classList.add('weghalen');
